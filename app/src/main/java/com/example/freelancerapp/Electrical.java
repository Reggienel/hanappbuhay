...
public class Electrical extends AppCompatActivity implements OnNoteListener{
    TextView textView;
    //initialize variable
...
//in your OnCreate() method
        myAwesomeTextView.setText("ELECTRICAL");
    ...
    public void onItemClicked(User user) {
        ...
        intentE.putExtra("phonenum", userphonenum);
        intentE.putExtra("serviceprice", userprice);
        finish();
